...
class Bunyad_Theme_SmartMag
{
	...
	public function register_sidebars()
	{
		...
		// register dynamic sidebar
		register_sidebar(array(
			'name' => __('Home body in the Top', 'bunyad'),
			'id'   => 'home-body-in-top',
			'description' => __('Widgets in this area will be shown in the default sidebar.', 'bunyad'),
			'before_title' => '',
			'after_title'  => '',
		...
		register_sidebar(array(
			'name' => __('Home body in the middle', 'bunyad'),
			'id'   => 'home-body-in-middle',
			'description' => __('Widgets in this area will be shown in the default sidebar.', 'bunyad'),
			'before_title' => '',
			'after_title'  => '',
			'before_widget' => '',
		...
		register_sidebar(array(
			'name' => __('Home body in the bottom', 'bunyad'),
			'id'   => 'home-body-in-bottom',
			'description' => __('Widgets in this area will be shown in the default sidebar.', 'bunyad'),
			'before_title' => '',
			'after_title'  => '',
			'before_widget' => '',
